...
def draw_style_mixing_figure(png, Gs, w, h, src_seeds, dst_seeds, style_ranges):
    ...
    src_dlatents =  np.load('latent_representations_mxy/ori/0_01.npy').reshape(1,18,512) # [seed, layer, component]
    dst_dlatents =  np.load('latent_representations_mxy/ori/5_01.npy').reshape(1,18,512)# [seed, layer, componentDSC_5980_01.npy]
...
if __name__ == "__main__":
    ...
    main()
    end_ = time.time()
    logging.debug('StyleGAN 人链融合部分花费时间: ')
    print(end_ - start_)
