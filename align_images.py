...
if __name__ == "__main__":
    ...
    parser.add_argument('--raw_dir', help='Directory with raw images for face alignment', default='raw_images_black')
    parser.add_argument('--aligned_dir', help='Directory for storing aligned images', default='aligned_images_black')
